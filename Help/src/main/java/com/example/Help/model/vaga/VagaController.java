...
public class VagaController {
    ...
    @CrossOrigin(origins = "http://localhost:3000", allowedHeaders = "*") //não deixa qualquer lugar acessar os dados
    ...
    public void saveVaga(@RequestBody Vaga data) { //ele lê os dados que vem em JSON e encaixa eles
        repository.save(data); //ele está escrevendo automaticamente os comandos de sql, por exemplo, verifica se o código é em ID, ou UUID, se for novo ele sobe para o banco e salva, se já existir ele atualiza
    }
