...
function Home() {
  ...
  useEffect(() => {
    ...
    // O delay de 100ms garante que o React terminou de renderizar os elementos com '.reveal' no DOM
    ...
    const handleHashScroll = () => {
      ...
      // Trata os formatos possíveis de hash no ecossistema do HashRouter
    ...
    <div className="home-wrapper">
      <header className="header-glass">
        <div className="header-content-top">
          ...
          {/* Ajustado os hrefs para IDs puros, garantindo a rolagem suave sem quebrar a rota padrão */}
