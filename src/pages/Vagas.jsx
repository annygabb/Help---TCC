...
import { Home, BookOpen, Briefcase, MessageSquare, Bell, Search, MapPin, DollarSign, Building } from 'lucide-react';
import './Vagas.css';
          ...
          {listaVagas.map(vaga => (
            <div className="post" key={vaga.id} style={{ padding: '20px' }}>
              <div style={{ display: 'flex', gap: '15px' }}>
                ...
                <div>
                  <h4 style={{ color: 'white', fontSize: '16px' }}>{vaga.cargo}</h4>
                  <p style={{ color: '#a755f7', fontSize: '14px', fontWeight: '600' }}>{vaga.empresa}</p>
